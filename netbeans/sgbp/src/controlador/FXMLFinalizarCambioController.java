...
public class FXMLFinalizarCambioController implements Initializable {
        ...
        public void initialize(URL location, ResourceBundle resources) {
                ...
                tvCambios.getSelectionModel().selectedItemProperty()
                        .addListener(
        ...
        private void mostrarDatos() {
                ...
                if (!(Boolean) respuesta.get("error")) {
                        ...
                        colFechaInicio.setCellValueFactory(
                                new PropertyValueFactory<>(
                                        "fechaInicio"));
                        colTipoActividad.setCellValueFactory(
                                new PropertyValueFactory<>(
                                        "tipoActividad"));
                        ...
                        String mensajeError = respuesta.get("mensaje")
                                .toString();
                        Alertas.mostrarAlerta("Error",
                                        mensajeError,
                                        AlertType.ERROR);

                        Stage escenario = (Stage) tvCambios.getScene()
                                .getWindow();
                        escenario.close();
                }
        ...
        private void btnFinalizarClic(ActionEvent event) {
                ...
                HashMap<String, Object> respuesta = CambioDAO.finalizarCambio(
                                tvCambios.getSelectionModel()
                                        .getSelectedItem().getIdCambio(),
