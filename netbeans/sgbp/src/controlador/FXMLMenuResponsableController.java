/*
 * Nombre del archivo: FXMLMenuResponsableController.java
 * Autor: Albhieri Cristoff Villa Contreras
 * Paquete: controlador
 * Fecha de creación: 03/12/2023
 * Fecha de modificación: 14/12/2023
 * Descripción: Clase controlador para la ventana de menú del responsable
 */
    ...
    private void btnAsignarEstudianteP(MouseEvent event) {
        ...
        try {
            ...
            FXMLAsignarEstudianteAProyectoController controlador = loader
                    .getController();
            controlador.inicializarVentana(idProyecto, idPeriodoProyecto);
            escena.getStylesheets().add(Utilidades.getURLString(
                    "/vista/estilos/escenaFormulario.css"));
