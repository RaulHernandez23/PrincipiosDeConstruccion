/*
 * Nombre del archivo: ActividadDAO.java
 * Autor: Raul Hernandez Olivares
 * Paquete: modelo/dao
 * Fecha de creación: 19/11/2023
 * Fecha de modificación: 13/12/2023
 * Descripción: Clase que contiene los métodos de la actividad
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    actividad.setTitulo(resultadoConsulta.getString(
                            "titulo"));
                    actividad.setDescripcion(resultadoConsulta
                            .getString(
                            "descripcion"));
                    actividad.setEsfuerzoMinutos(resultadoConsulta
                            .getInt(
                            "esfuerzoMinutos"));
                    actividad.setFechaInicio(resultadoConsulta
                            .getString(
                            "fechaInicio"));
                    actividad.setFechaFin(resultadoConsulta.getString(
                            "fechaFin"));
                    actividad.setIdEstadoActividad(
                            resultadoConsulta.getInt(
                            "idEstadoActividad"));
                    actividad.setEstadoActividad(resultadoConsulta
                            .getString(
                            "estadoActividad"));
                    ...
                    actividad.setTipo(resultadoConsulta.getString(
                            "tipo"));
                    actividad.setIdEstudiante(resultadoConsulta
                            .getInt(
                            "idEstudiante"));
                    actividad.setEstudiante(resultadoConsulta
                            .getString(
                            "estudiante"));
                    actividad.setIdResponsable(resultadoConsulta
                            .getInt(
                            "idResponsable"));
                    actividad.setResponsable(resultadoConsulta
                            .getString(
                            "responsable"));
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    actividad.setResponsable(resultadoConsulta
                            .getString(
                            "responsable"));
                    actividad.setIdProyecto(resultadoConsulta
                            .getInt(
                            "idProyecto"));
                    actividad.setProyecto(resultadoConsulta.getString(
                            "proyecto"));
    ...
    public static HashMap<String, Object> asignarActividad(int idActividad,
        ...
        if (conexion != null) {
            ...
            try {
                ...
                sqlE.printStackTrace();
                respuesta.put("mensaje", 
                        Constantes.MENSAJE_ERROR_UPDATE);
    ...
    public static HashMap<String, Object> eliminarActividad(int idActividad) {
        ...
        if (conexion != null) {
            ...
            try {
                ...
                sqlE.printStackTrace();
                respuesta.put("mensaje", 
                        Constantes.MENSAJE_ERROR_DELETE);
            }
        } else {
            respuesta.put("mensaje", 
                    Constantes.MENSAJE_ERROR_DE_CONEXION);
