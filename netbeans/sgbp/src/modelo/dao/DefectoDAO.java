            ...
            try {
                ...
                while (resultado.next()) {
                    ...
                    defectoMap.put("idEstudiante", resultado.getInt(
                            "idEstudiante"));
                    defectoMap.put("estadoActividad", resultado
                            .getString(
                            "estadoActividad"));
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    defecto.setTitulo(resultadoConsulta.getString(
                            "titulo"));
                    defecto.setDescripcion(resultadoConsulta
                            .getString(
                            "descripcion"));
                    defecto.setEsfuerzoMinutos(resultadoConsulta
                            .getInt(
                            "esfuerzoMinutos"));
                    defecto.setFechaReporte(resultadoConsulta
                            .getString(
                            "fechaReporte"));
                    defecto.setIdEstadoDefecto(resultadoConsulta
                            .getInt(
                            "idEstadoDefecto"));
                    defecto.setIdEstudiante(resultadoConsulta.getInt(
                            "estadoDefecto"));
                    defecto.setNombreEstudiante(resultadoConsulta
                            .getString(
                            "nombreEstudiante"));
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    defecto.setIdEstadoDefecto(resultadoConsulta
                            .getInt(
                            "idEstadoDefecto"));
                    defecto.setEstadoDefecto(resultadoConsulta
                            .getString(
                            "estadoDefecto"));
                    defecto.setNombreEstudiante(resultadoConsulta
                            .getString(
