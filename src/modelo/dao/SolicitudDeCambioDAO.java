        ...
        if (conexionBD != null) {
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    estado.setIdEstadoSolicitud(resultadoConsulta.getInt(
                            "IdEstadoSolicitud"));
        ...
        if (conexionBD != null) {
            ...
            try {
                ...
                while (resultadoConsulta.next()) {
                    ...
                    solicitud.setIdSolicitudDeCambio(resultadoConsulta
                    ...
                    solicitud.setIdEstadoSolicitud(resultadoConsulta
    ...
    public static HashMap<String, Object> registrarSolicitud(
        ...
        if (conexionBD != null) {
            ...
            try {
                ...
                sentencia.setDate(6,
                        java.sql.Date.valueOf(solicitud.getFechaCreacion()));
                sentencia.setInt(7,
