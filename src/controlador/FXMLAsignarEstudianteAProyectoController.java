...
public class FXMLAsignarEstudianteAProyectoController implements Initializable {
    ...
    private void registrarEstudiante(){
        ...
        if(!(Boolean)respuesta.get("error")){
            Utilidades.mostrarAlertaSimple("Registro exitoso", 
                    (String)respuesta.get("mensaje") + "\nLa contraseña del estudiante es: "+ password, Alert.AlertType.INFORMATION);
            cerrarVentana();
        }else{
    ...
    private void configurarListenerACampos(){
        ...
        ChangeListener<String> cambiosEnCampos = new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
                // Verificar si todos los campos están llenos y habilitar/deshabilitar el botón en consecuencia
    ...
    private boolean validarCampos(){
        ...
        limpiarEstiloCampos();
            ...
            if (tfNombre.getText().isEmpty() || !tfNombre.getText().matches("[a-zA-ZáéíóúÁÉÍÓÚüÜ]+( [a-zA-ZáéíóúÁÉÍÓÚüÜ]+)?")) {
