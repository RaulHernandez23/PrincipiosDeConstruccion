...
public class FXMLConsultarDefectosController implements Initializable{
    ...
    @FXML
    TableColumn<Defecto, Date> colFechaReporteDefectos;
    ...
    private void mostrarDatos() {
        ...
        try {
            ...
            colEstadoDefectos.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getEstadoActividad()));
            colFechaReporteDefectos.setCellValueFactory(cellData -> new SimpleObjectProperty<>(cellData.getValue().getFechaReporte()));
